...
$email=$fetch['email'];
    if (isset($_POST["reset_email"]))
    {
        ...
        try {
            ...
            $random_ver = substr(number_format(time() * rand(), 0, '', ''), 0, 6);
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" id="background-table" style="table-layout:fixed" align="center">
                            ...
                            <tbody><tr>
                                <td class="w580" width="580">
                                    ...
                                    <div align="left" class="article-content">
                                        <multiline label="Description">The code to change your email is:: <b style="font-size: 30px;">' . $random_ver . '</b></multiline>
                                    </div>
                                </td>
                            </tr>
    ...
    <table id="footer" class="w640" width="640" cellpadding="0" cellspacing="0" border="0" bgcolor="#043948">
        ...
        <tr><td class="w30" width="30"></td><td class="w580 h0" width="360" height="15"></td><td class="w0" width="60"></td><td class="w0" width="160"></td><td class="w30" width="30"></td></tr>
            ...
            $encrypted_verification = md5($random_ver);

            $sql = "UPDATE users SET verification_email='". $encrypted_verification ."' WHERE email='".$email."'";

			mysqli_query($conn, $sql);

            header("Location: change-e.php?success=OKKK");
...
<p>Vous devriez saisir un code de vérification reçu à l'adresse e-mail <?php echo $fetch['email']; ?> </p>
