<?php
    ...
    if (isset($_POST["send"]))
    {
        ...
        try {
            ...
            //mail admin
            $mail->addAddress('anas.el-gana@etu.univ-cotedazur.fr');
                ...
                <repeater>
                    ...
                    <layout label="Text only">
                        <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                            <tbody><tr>
                                <td class="w580" width="580">
                                    <p align="left" class="article-title"><singleline label="Title">Demande de contact</singleline></p>
                                    <div align="left" class="article-content">
                                        <multiline label="Description">Message from ' . $name . ','.$surname.','.$email.'</multiline> <br>
                                        <multiline label="Description">Demande : '.$message.'</multiline>
                                    </div>
                                </td>
                            </tr>
...
$mail->send();
header("Location: contact.php?success=Message envoye avec succes");
        } catch (Exception $e) {
