        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="create_annonce.php">Depo annonce</a></li> 
              <li><a href="users.php">Messagerie</a></li>
                ...
                <?php 
                  ...
                  <div class="listing-item">
                    ...
                    <div class="right-content align-self-center">
                      ...
                      <span class="price"><div class="icon"><img src="assets/images/listing-icon-01.png" alt=""></div><?php echo $row['prix']; ?> €</span>
